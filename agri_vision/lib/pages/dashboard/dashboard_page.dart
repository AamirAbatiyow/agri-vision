            ...
            slivers: [
              ...
              SliverToBoxAdapter(
                child: Padding(
                  ...
                  child: StreamBuilder<WeatherNow>(
                    stream: _weather$,
                    builder: (context, ws) {
                      final now = ws.data;
                      return _WeatherNowCard(now: now);
                    },
                  ),
                ),
              ),

              // --- Metric grid (from SensorService) ---
              SliverPadding(
                ...
                sliver: SliverGrid.count(
                  ...
                  children: [
                    MetricCard(
                      title: 'Temperature',
                      value: '${s.temperatureF.toStringAsFixed(1)}°F',
                      subtitle: _trendText(tempHistory),
                    ...
                    MetricCard(
                      ...
                      subtitle: s.sunlight < 8 ? 'Low light' : 'Good exposure',
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text('${d.precipProb.toStringAsFixed(0)}%',
